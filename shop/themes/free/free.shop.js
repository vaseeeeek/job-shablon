var filter = {
        ...
        showElem: function () {
            $(".js-filter-title").on("click", function () {
                var e = $(this).closest(".js-filter-el"),
                    t = e.find(".js-filter-options");
                t.is(":visible") ? (t.slideUp(), e.addClass("close")) : (t.slideDown(), e.removeClass("close"));
            });
        },
        showMobFilter: function () {
            var e = $(".js-mobile-filter-head"),
                t = $(".js-mobile-filter-body");
            e.on("click", function () {
        ...
        rangeFilter: function (e) {
            e.each(function () {
                if (!$(this).find(".js-slider-range").length) {
                    ...
                    var e = $(this).find(".js-min"),
                        t = $(this).find(".js-max"),
                        a = parseFloat(e.attr("placeholder")),
                        i = parseFloat(t.attr("placeholder")),
                        r = 1,
                        s = $(this).find(".js-slider-range");
                    if (s.data("step")) r = parseFloat(s.data("step"));
                    else {
                        var n = i - a;
        ...
        showMoreFilter: function () {
            $(".js-filter-options-show-all").click(function (e) {
                e.preventDefault();
                var t = $(this),
                    a = t.closest(".js-filter-options"),
                    i = a.find(".js-filter-options-el");
                i.is(":hidden") ? (i.removeClass("hide"), t.addClass("open")) : (i.addClass("hide"), t.removeClass("open"));
            });
        },
        smartfilterRefrCloseFilter: function () {
            void 0 !== $.smartfiltersTheme &&
            setTimeout(function () {
                var e = $(".js-filter-options-show-all");
                $(".js-filters").data("smartfilters-hide-option") &&
                e.each(function () {
                    var e = $(this),
                        t = e.hasClass("open"),
                        a = parseInt(e.data("max-show-params")),
                        i = e.closest(".js-filter-el").find("label"),
                        r = 0;
                    a &&
                    (e.hide(),
                        i.each(function () {
        ...
        selectedFiltersClear: function () {
            ...
            $("body").on("click", ".js-filter-checked-remove", function () {
                ...
                $(".js-filters").length && (e.clearFilterItem(t), itemList.ajaxUpListForm($(".js-filters form").serializeArray()));
            });
        },
        clearFilterItem: function (e) {
            var t = this,
                a = $(".js-filters").find(".js-filter-el[data-code='" + e + "']");
            a.find('input[type="checkbox"], input[type="radio"]').prop("checked", !1).trigger("refresh"), a.find('input[type="text"]').val(""), $(".js-filters .js-slider-range").remove(), t.rangeFilter($(".js-filters .js-filter-range"));
        },
        subcatFilterAdd: function (e) {
            var t = $(".js-cat_sub"),
                a = t.data("save-filters"),
                i = t.data("save-filters-aliases"),
                r = e,
        ...
        initialFilterSubcat: function () {
            var e = this,
                t = $(".js-filters form");
            t.length && e.subcatFilterAdd(t.serializeArray());
        },
    ...
    paginationLazyLoad = {
        init: function () {
            if ($.fn.lazyLoad) {
                var e = $(".lazy-paging");
                if (!e.length) return;
                var t = parseInt(e.data("times"), 10),
                    a = e.data("loading-str") || "Loading...",
                ...
                r.lazyLoad({
                    ...
                    load: function () {
                        ...
                        $.get(n, function (a) {
                            ...
                            e.replaceWith(s),
                                (e = s),
                                e.find("li.selected").next().length
                                    ? !isNaN(t) && t <= 0
                                    ? (r.lazyLoad("sleep"),
                                    $(".lazyloading-load-more").length ||
                                    $('<a href="#" class="lazyloading-load-more">' + link_text + "</a>")
                                        .insertAfter(e)
                                        .click(function () {
        ...
        moreDetails: function () {
            ...
            if (($(".js-category-desc-more-wrap").remove(), e.removeClass("close"), e.length && t && e.css("max-height", t + "px"), e.length && a.length && e.outerHeight() < a.outerHeight())) {
                var i = e.data("text-more"),
                    r = e.data("text-hide");
                e.addClass("close"),
                    e.after("<div class='js-category-desc-more-wrap category-desc-more-wrap'><span class='js-category-desc-more category-desc-more sdColor link-half'>" + i + "</span></div>"),
                    $(".js-category-desc-more").on("click", function () {
                        var s = $(this);
                        s.hasClass("open")
                            ? (s.removeClass("open"), e.addClass("close"), s.text(i), e.animate({ maxHeight: t }, 500))
                            : (e.animate({ maxHeight: a.outerHeight() + "px" }, 500), s.addClass("open"), e.removeClass("close"), s.text(r));
                    });
