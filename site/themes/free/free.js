...
var mobileMenuBtn = {
    ...
    hideShow: function () {
        var _this = this,
            mobileMenuBtnOpen = $(".js-nav-button"),
            mobileMenuSubCatCloseBtn = $(".menu-close");
        ...
        mobileMenuBtnOpen.on("click", function () {
            ...
            subCatMenu = $('.MobileMenu_nav-m .js-subcategory-menu');
        ...
        mobileMenuSubCatCloseBtn.on("click", function () {
            var $this = $(this),
...
void 0 === jQuery.migrateMute && (jQuery.migrateMute = !0), function (t, e, i) {
    ...
    s(t, "attrFn", a || {}, "jQuery.attrFn is deprecated"), t.attr = function (e, s, o, l) {
        var c = s.toLowerCase(), f = e && e.nodeType;
    ...
    var f, m, g = t.fn.init, v = t.parseJSON, _ = /^([^<]*)(<[\w\W]+>)([^>]*)$/;
    ...
    var b = /\/(java|ecma)script/i, w = t.fn.andSelf || t.fn.addBack;
    ...
    var x = t.event.add, C = t.event.remove, k = t.event.trigger, S = t.fn.toggle, T = t.fn.live, I = t.fn.die,
        D = "ajaxStart|ajaxStop|ajaxSend|ajaxComplete|ajaxError|ajaxSuccess", E = RegExp("\\b(?:" + D + ")\\b"),
        A = /(?:^|\s)hover(\.\S+|)\b/, P = function (e) {
    ...
    t.event.props && "attrChange" !== t.event.props[0] && t.event.props.unshift("attrChange", "attrName", "relatedNode", "srcElement"), t.event.dispatch && s(t.event, "handle", t.event.dispatch, "jQuery.event.handle is undocumented and deprecated"), t.event.add = function (t, e, i, s, o) {
        ...
        var s = arguments, o = e.guid || t.guid++, a = 0, r = function (i) {
    ...
    var l = "transitionend", c = {
        TRANSITION_END: "bsTransitionEnd", getUID: function (t) {
            ...
            if (!t) return 0;
            var i = e(t).css("transition-duration"), n = e(t).css("transition-delay"), s = parseFloat(i),
                o = parseFloat(n);
    ...
    var d = "alert", u = "bs.alert", h = "." + u, p = e.fn[d],
        f = {CLOSE: "close" + h, CLOSED: "closed" + h, CLICK_DATA_API: "click" + h + ".data-api"}, m = "alert",
        g = "fade", v = "show", _ = function () {
            function t(t) {
                this._element = t
            }
            ...
            return i.close = function (t) {
                ...
                var i = c.getSelectorFromElement(t), n = !1;
    ...
    var y = "button", b = "bs.button", w = "." + b, x = ".data-api", C = e.fn[y], k = "active",
        S = '[data-toggle^="button"]', T = '[data-toggle="buttons"]', I = 'input:not([type="hidden"])', D = ".active",
        E = ".btn", A = {CLICK_DATA_API: "click" + w + x, FOCUS_BLUR_DATA_API: "focus" + w + x + " blur" + w + x},
        P = function () {
            function t(t) {
                this._element = t
            }
            ...
            return i.toggle = function () {
                var t = !0, i = !0, n = e(this._element).closest(T)[0];
                if (n) {
    ...
    var M = "carousel", j = "bs.carousel", $ = "." + j, O = ".data-api", N = e.fn[M],
        L = {interval: 5e3, keyboard: !0, slide: !1, pause: "hover", wrap: !0, touch: !0}, z = {
            ...
            wrap: "boolean",
            touch: "boolean"
        }, F = "next", H = "prev", W = "left", R = "right", B = {
            SLIDE: "slide" + $,
            SLID: "slid" + $,
            KEYDOWN: "keydown" + $,
        ...
        }, q = "carousel", U = "active", Y = "slide", K = "carousel-item-right", V = "carousel-item-left",
        Q = "carousel-item-next", Z = "carousel-item-prev", G = "pointer-event", X = ".active",
        J = ".active.carousel-item", tt = ".carousel-item", et = ".carousel-item img",
        it = ".carousel-item-next, .carousel-item-prev", nt = ".carousel-indicators", st = '[data-ride="carousel"]',
        ot = {TOUCH: "touch", PEN: "pen"}, at = function () {
            function t(t, e) {
            ...
            return i.next = function () {
                ...
                if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) e(this._element).one(B.SLID, function () {
                    return i.to(t)
                }); else {
                ...
                var i = t === F, n = t === H, s = this._getItemIndex(e), o = this._items.length - 1;
                if ((n && 0 === s || i && s === o) && !this._config.wrap) return e;
                var a = (s + (t === H ? -1 : 1)) % this._items.length;
                return -1 === a ? this._items[this._items.length - 1] : this._items[a]
            }, i._triggerSlideEvent = function (t, i) {
                var n = this._getItemIndex(t), s = this._getItemIndex(this._element.querySelector(J)),
                    o = e.Event(B.SLIDE, {relatedTarget: t, direction: i, from: s, to: n});
                ...
                var n, s, o, a = this, r = this._element.querySelector(J), l = this._getItemIndex(r),
                    d = i || r && this._getItemByDirection(t, r), u = this._getItemIndex(d), h = Boolean(this._interval);
                if (o = t === F ? (n = V, s = Q, W) : (n = K, s = Z, R), d && e(d).hasClass(U)) this._isSliding = !1; else if (!this._triggerSlideEvent(d, o).isDefaultPrevented() && r && d) {
                    this._isSliding = !0, h && this.pause(), this._setActiveIndicatorElement(d);
                    var p = e.Event(B.SLID, {relatedTarget: d, direction: o, from: l, to: u});
                ...
                return this.each(function () {
                    var n = e(this).data(j), s = o({}, L, e(this).data());
                    "object" == typeof i && (s = o({}, s, i));
                    var a = "string" == typeof i ? i : s.slide;
                    if (n || (n = new t(this, s), e(this).data(j, n)), "number" == typeof i) n.to(i); else if ("string" == typeof a) {
                ...
                if (n) {
                    var s = e(n)[0];
                    if (s && e(s).hasClass(q)) {
                        var a = o({}, e(s).data(), e(this).data()), r = this.getAttribute("data-slide-to");
    ...
    var rt = "collapse", lt = "bs.collapse", ct = "." + lt, dt = e.fn[rt], ut = {toggle: !0, parent: ""},
        ht = {toggle: "boolean", parent: "(string|element)"}, pt = {
            SHOW: "show" + ct,
            SHOWN: "shown" + ct,
            HIDE: "hide" + ct,
            HIDDEN: "hidden" + ct,
            CLICK_DATA_API: "click" + ct + ".data-api"
        }, ft = "show", mt = "collapse", gt = "collapsing", vt = "collapsed", _t = "width", yt = "height",
        bt = ".show, .collapsing", wt = '[data-toggle="collapse"]', xt = function () {
            function t(t, e) {
                this._isTransitioning = !1, this._element = t, this._config = this._getConfig(e), this._triggerArray = [].slice.call(document.querySelectorAll('[data-toggle="collapse"][href="#' + t.id + '"],[data-toggle="collapse"][data-target="#' + t.id + '"]'));
                for (var i = [].slice.call(document.querySelectorAll(wt)), n = 0, s = i.length; n < s; n++) {
                    var o = i[n], a = c.getSelectorFromElement(o),
            ...
            return i.toggle = function () {
                ...
                if (!this._isTransitioning && e(this._element).hasClass(ft)) {
                    ...
                    if (e(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        if (0 < s) for (var o = 0; o < s; o++) {
                            var a = this._triggerArray[o], r = c.getSelectorFromElement(a);
                ...
                return this.each(function () {
                    var n = e(this), s = n.data(lt), a = o({}, ut, n.data(), "object" == typeof i && i ? i : {});
    ...
    e(document).on(pt.CLICK_DATA_API, wt, function (t) {
        ...
        var i = e(this), n = c.getSelectorFromElement(this), s = [].slice.call(document.querySelectorAll(n));
        e(s).each(function () {
            var t = e(this), n = t.data(lt) ? "toggle" : i.data();
    ...
    var Ct = "dropdown", kt = "bs.dropdown", St = "." + kt, Tt = ".data-api", It = e.fn[Ct],
        Dt = new RegExp("38|40|27"), Et = {
            HIDE: "hide" + St,
            HIDDEN: "hidden" + St,
            SHOW: "show" + St,
            SHOWN: "shown" + St,
        ...
        }, At = "disabled", Pt = "show", Mt = "dropup", jt = "dropright", $t = "dropleft", Ot = "dropdown-menu-right",
        Nt = "position-static", Lt = '[data-toggle="dropdown"]', zt = ".dropdown-menu", Ft = ".navbar-nav",
        Ht = ".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", Wt = "top-start", Rt = "top-end",
        Bt = "bottom-start", qt = "bottom-end", Ut = "right-start", Yt = "left-start",
        Kt = {offset: 0, flip: !0, boundary: "scrollParent", reference: "toggle", display: "dynamic"}, Vt = {
            ...
            return n.toggle = function () {
                if (!this._element.disabled && !e(this._element).hasClass(At)) {
                    var n = t._getParentFromElement(this._element), s = e(this._menu).hasClass(Pt);
                    if (t._clearMenus(), !s) {
                        var o = {relatedTarget: this._element}, a = e.Event(Et.SHOW, o);
                ...
                var t = e(this._element.parentNode), i = Bt;
                ...
                if (!i || 3 !== i.which && ("keyup" !== i.type || 9 === i.which)) for (var n = [].slice.call(document.querySelectorAll(Lt)), s = 0, o = n.length; s < o; s++) {
                    var a = t._getParentFromElement(n[s]), r = e(n[s]).data(kt), l = {relatedTarget: n[s]};
                ...
                if ((/input|textarea/i.test(i.target.tagName) ? !(32 === i.which || 27 !== i.which && (40 !== i.which && 38 !== i.which || e(i.target).closest(zt).length)) : Dt.test(i.which)) && (i.preventDefault(), i.stopPropagation(), !this.disabled && !e(this).hasClass(At))) {
                    var n = t._getParentFromElement(this), s = e(n).hasClass(Pt);
    ...
    var Zt = "modal", Gt = "bs.modal", Xt = "." + Gt, Jt = e.fn[Zt],
        te = {backdrop: !0, keyboard: !0, focus: !0, show: !0},
        ee = {backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean", show: "boolean"}, ie = {
            HIDE: "hide" + Xt,
            HIDDEN: "hidden" + Xt,
            SHOW: "show" + Xt,
            SHOWN: "shown" + Xt,
        ...
        }, ne = "modal-dialog-scrollable", se = "modal-scrollbar-measure", oe = "modal-backdrop", ae = "modal-open",
        re = "fade", le = "show", ce = ".modal-dialog", de = ".modal-body", ue = '[data-dismiss="modal"]',
        he = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", pe = ".sticky-top", fe = function () {
            function t(t, e) {
            ...
            return i.toggle = function (t) {
                ...
                if (!this._isShown && !this._isTransitioning) {
                    ...
                    var n = e.Event(ie.SHOW, {relatedTarget: t});
                ...
                var i = this, n = e(this._element).hasClass(re);
                ...
                var s = e.Event(ie.SHOWN, {relatedTarget: t}), o = function () {
                ...
                var i = this, n = e(this._element).hasClass(re) ? re : "";
                ...
                if (this._isBodyOverflowing) {
                    var i = [].slice.call(document.querySelectorAll(he)), n = [].slice.call(document.querySelectorAll(pe));
                ...
                return this.each(function () {
                    var s = e(this).data(Gt), a = o({}, te, e(this).data(), "object" == typeof i && i ? i : {});
    ...
    var me = ["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"], ge = {
        ...
        ye = "tooltip", be = "bs.tooltip", we = "." + be, xe = e.fn[ye], Ce = "bs-tooltip",
        ke = new RegExp("(^|\\s)" + Ce + "\\S+", "g"), Se = ["sanitize", "whiteList", "sanitizeFn"], Te = {
            animation: "boolean",
            template: "string",
            ...
            whiteList: "object"
        }, Ie = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}, De = {
            animation: !0,
        ...
        }, Me = "fade", je = "show", $e = ".tooltip-inner", Oe = ".arrow", Ne = "hover", Le = "focus", ze = "click",
        Fe = "manual", He = function () {
            function t(t, e) {
            ...
            return n.enable = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var a = this.getTipElement(), r = c.getUID(this.constructor.NAME);
                ...
                var t = e(this.getTipElement()), i = t.attr("class").match(ke);
                ...
                return this.each(function () {
                    var n = e(this).data(be), s = "object" == typeof i && i;
    ...
    var We = "popover", Re = "bs.popover", Be = "." + Re, qe = e.fn[We], Ue = "bs-popover",
        Ye = new RegExp("(^|\\s)" + Ue + "\\S+", "g"), Ke = o({}, He.Default, {
            placement: "right",
            trigger: "click",
            content: "",
            template: '<div class="popover" role="tooltip"><div class="arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>'
        }), Ve = o({}, He.DefaultType, {content: "(string|element|function)"}), Qe = "fade", Ze = "show",
        Ge = ".popover-header", Xe = ".popover-body", Je = {
            HIDE: "hide" + Be,
            HIDDEN: "hidden" + Be,
            SHOW: "show" + Be,
            SHOWN: "shown" + Be,
            ...
            return a.isWithContent = function () {
                ...
                var t = e(this.getTipElement()), i = t.attr("class").match(Ye);
                null !== i && 0 < i.length && t.removeClass(i.join(""))
            }, i._jQueryInterface = function (t) {
                return this.each(function () {
                    var n = e(this).data(Re), s = "object" == typeof t ? t : null;
    ...
    var ei = "scrollspy", ii = "bs.scrollspy", ni = "." + ii, si = e.fn[ei],
        oi = {offset: 10, method: "auto", target: ""},
        ai = {offset: "number", method: "string", target: "(string|element)"},
        ri = {ACTIVATE: "activate" + ni, SCROLL: "scroll" + ni, LOAD_DATA_API: "load" + ni + ".data-api"},
        li = "dropdown-item", ci = "active", di = '[data-spy="scroll"]', ui = ".nav, .list-group", hi = ".nav-link",
        pi = ".nav-item", fi = ".list-group-item", mi = ".dropdown", gi = ".dropdown-item", vi = ".dropdown-toggle",
        _i = "offset", yi = "position", bi = function () {
            function t(t, i) {
                var n = this;
            ...
            return i.refresh = function () {
                var t = this, i = this._scrollElement === this._scrollElement.window ? _i : yi,
                    n = "auto" === this._config.method ? i : this._config.method, s = n === yi ? this._getScrollTop() : 0;
                ...
                n.hasClass(li) ? (n.closest(mi).find(vi).addClass(ci), n.addClass(ci)) : (n.addClass(ci), n.parents(ui).prev(hi + ", " + fi).addClass(ci), n.parents(ui).prev(pi).children(hi).addClass(ci)), e(this._scrollElement).trigger(ri.ACTIVATE, {relatedTarget: t})
            }, i._clear = function () {
    ...
    var wi = "bs.tab", xi = "." + wi, Ci = e.fn.tab, ki = {
            HIDE: "hide" + xi,
            HIDDEN: "hidden" + xi,
            SHOW: "show" + xi,
            SHOWN: "shown" + xi,
            CLICK_DATA_API: "click" + xi + ".data-api"
        }, Si = "dropdown-menu", Ti = "active", Ii = "disabled", Di = "fade", Ei = "show", Ai = ".dropdown",
        Pi = ".nav, .list-group", Mi = ".active", ji = "> li > .active", $i = ".dropdown-toggle",
        Oi = "> .dropdown-menu .active", Ni = function () {
            function t(t) {
                this._element = t
            }
            ...
            return i.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && e(this._element).hasClass(Ti) || e(this._element).hasClass(Ii))) {
                    var i, n, s = e(this._element).closest(Pi)[0], o = c.getSelectorFromElement(this._element);
                    if (s) {
                        var a = "UL" === s.nodeName || "OL" === s.nodeName ? ji : Mi;
                        n = (n = e.makeArray(e(s).find(a)))[n.length - 1]
                    }
                    var r = e.Event(ki.HIDE, {relatedTarget: this._element}), l = e.Event(ki.SHOW, {relatedTarget: n});
                    if (n && e(n).trigger(r), e(this._element).trigger(l), !l.isDefaultPrevented() && !r.isDefaultPrevented()) {
                        ...
                        var d = function () {
                            var i = e.Event(ki.HIDDEN, {relatedTarget: t._element}),
                                s = e.Event(ki.SHOWN, {relatedTarget: n});
                ...
                var s = this, o = (!i || "UL" !== i.nodeName && "OL" !== i.nodeName ? e(i).children(Mi) : e(i).find(ji))[0],
                    a = n && o && e(o).hasClass(Di), r = function () {
    ...
    var Li = "toast", zi = "bs.toast", Fi = "." + zi, Hi = e.fn[Li], Wi = {
            CLICK_DISMISS: "click.dismiss" + Fi,
            HIDE: "hide" + Fi,
            HIDDEN: "hidden" + Fi,
            SHOW: "show" + Fi,
            SHOWN: "shown" + Fi
        }, Ri = "fade", Bi = "hide", qi = "show", Ui = "showing",
        Yi = {animation: "boolean", autohide: "boolean", delay: "number"},
        Ki = {animation: !0, autohide: !0, delay: 500}, Vi = '[data-dismiss="toast"]', Qi = function () {
            function t(t, e) {
    ...
    }(), t.Util = c, t.Alert = _, t.Button = P, t.Carousel = at, t.Collapse = xt, t.Dropdown = Qt, t.Modal = fe, t.Popover = ti, t.Scrollspy = bi, t.Tab = Ni, t.Toast = Qi, t.Tooltip = He, Object.defineProperty(t, "__esModule", {value: !0})
}), function (t) {
    "use strict";
    ...
    function r(t, e) {
        if (t && t.getAttribute(I)) e(t); else for (var i, n = t ? t.getElementsByTagName("input") : F, s = t ? t.getElementsByTagName("textarea") : H, o = n ? n.length : 0, a = s ? s.length : 0, r = o + a, l = 0; r > l; l++) i = o > l ? n[l] : s[l - o], e(i)
    }
    ...
    function d(t, e) {
        var i = !!e && t.value !== e, n = t.value === t.getAttribute(I);
    ...
    var y = document.createElement("input"), b = void 0 !== y.placeholder;
    if (t.Placeholders = {nativeSupport: b, disable: b ? e : l, enable: b ? e : c}, !b) {
        var w, x = ["text", "search", "url", "tel", "email", "password", "number", "textarea"],
            C = [27, 33, 34, 35, 36, 37, 38, 39, 40, 8, 46], k = "#ccc", S = "placeholdersjs",
            T = new RegExp("(?:^|\\s)" + S + "(?!\\S)"), I = "data-placeholder-value", D = "data-placeholder-active",
            E = "data-placeholder-type", A = "data-placeholder-submit", P = "data-placeholder-bound",
            M = "data-placeholder-focus", j = "data-placeholder-live", $ = "data-placeholder-maxlength", O = 100,
            N = document.getElementsByTagName("head")[0], L = document.documentElement, z = t.Placeholders,
            F = document.getElementsByTagName("input"), H = document.getElementsByTagName("textarea"),
            W = "false" === L.getAttribute(M), R = "false" !== L.getAttribute(j), B = document.createElement("style");
        B.type = "text/css";
        ...
        if (!t(o).data("bxSlider")) {
            var l = function () {
                ...
                o.wrap('<div class="' + s.settings.wrapperClass + '"><div class="bx-viewport"></div></div>'), s.viewport = o.parent(), s.settings.ariaLive && !s.settings.ticker && s.viewport.attr("aria-live", "polite"), s.loader = t('<div class="bx-loading" />'), s.viewport.prepend(s.loader), o.css({
                    ...
                    overflow: "hidden",
                    position: "relative"
                }), s.viewport.parent().css({maxWidth: p()}), s.children.css({
                ...
                var e, i, n, a = t || s.settings.speed, r = {left: 0, top: 0}, l = {left: 0, top: 0};
                "next" === s.settings.autoDirection ? r = o.find(".bx-clone").first().position() : l = s.children.first().position(), e = "horizontal" === s.settings.mode ? -r.left : -r.top, i = "horizontal" === s.settings.mode ? -l.left : -l.top, n = {resetValue: i}, y(e, "ticker", a, n)
            }, F = function (e) {
                ...
                var e = t.originalEvent, i = void 0 !== e.changedTouches ? e.changedTouches : [e],
                    n = Math.abs(i[0].pageX - s.touch.start.x), o = Math.abs(i[0].pageY - s.touch.start.y), a = 0,
                    r = 0;
                ...
                var i = e.originalEvent, n = void 0 !== i.changedTouches ? i.changedTouches : [i], a = 0, r = 0;
                ...
                if (s.initialized) if (s.working) window.setTimeout(Y, 10); else {
            ...
            return o.goToSlide = function (e, i) {
                var n, a, r, l, c = !0, d = 0, u = {left: 0, top: 0}, p = null;
                if (s.oldIndex = s.active.index, s.active.index = V(e), !s.working && s.active.index !== s.oldIndex) {
                    ...
                    "next" === i ? s.settings.onSlideNext.call(o, s.children.eq(s.active.index), s.oldIndex, s.active.index) || (c = !1) : "prev" === i && (s.settings.onSlidePrev.call(o, s.children.eq(s.active.index), s.oldIndex, s.active.index) || (c = !1)), s.active.last = s.active.index >= g() - 1, (s.settings.pager || s.settings.pagerCustom) && A(s.active.index), s.settings.controls && j(), "fade" === s.settings.mode ? (s.settings.adaptiveHeight && s.viewport.height() !== h() && s.viewport.animate({height: h()}, s.settings.adaptiveHeightSpeed), s.children.filter(":visible").fadeOut(s.settings.speed).css({zIndex: 0}), s.children.eq(s.active.index).css("zIndex", s.settings.slideZIndex + 1).fadeIn(s.settings.speed, function () {
                        t(this).css("zIndex", s.settings.slideZIndex), P()
                    })) : (s.settings.adaptiveHeight && s.viewport.height() !== h() && s.viewport.animate({height: h()}, s.settings.adaptiveHeightSpeed), !s.settings.infiniteLoop && s.carousel && s.active.last ? "horizontal" === s.settings.mode ? (p = s.children.eq(s.children.length - 1), u = p.position(), d = s.viewport.width() - p.outerWidth()) : (n = s.children.length - s.settings.minSlides, u = s.children.eq(n).position()) : s.carousel && s.active.last && "prev" === i ? (a = 1 === s.settings.moveSlides ? s.settings.maxSlides - v() : (g() - 1) * v() - (s.children.length - s.settings.maxSlides), p = o.children(".bx-clone").eq(a), u = p.position()) : "next" === i && 0 === s.active.index ? (u = o.find("> .bx-clone").eq(s.settings.maxSlides).position(), s.active.last = !1) : e >= 0 && (l = e * parseInt(v()), u = s.children.eq(l).position()), void 0 !== u && (r = "horizontal" === s.settings.mode ? -(u.left - d) : -u.top, y(r, "slide", s.settings.speed)), s.working = !1), s.settings.ariaHidden && K(s.active.index * v())
                }
                ...
                var u = function () {
                    ...
                    function l() {
                        for (var t = 0; t < u.length; t++) {
                            var e = u.eq(t), i = "", n = "", o = "", a = "", r = "", l = "", c = "", d = "", p = "";
                    ...
                    function c() {
                        var a = new e, c = "", d = n.data("placeholder"), p = n.data("search"),
                            f = n.data("search-limit"), m = n.data("search-not-found"),
                            g = n.data("search-placeholder"), v = n.data("z-index"), _ = n.data("smart-positioning");
                        ...
                        y.append(C);
                        var k = t("ul", C), S = t("li", C), T = t("input", C),
                        ...
                        var D = 0, E = 0;
                        if (S.css({display: "inline-block"}), S.each(function () {
                            var e = t(this);
                            e.innerWidth() > D && (D = e.innerWidth(), E = e.width())
                        }), S.css({display: ""}), w.is(".placeholder") && w.width() > D) w.width(w.width()); else {
                            var A = y.clone().appendTo("body").width("auto"), P = A.outerWidth();
                        ...
                        var M = y.outerHeight(!0), j = T.parent().outerHeight(!0) || 0, $ = k.css("max-height"),
                            O = S.filter(".selected");
                        ...
                        var L = C.css("top");
                        if ("auto" == C.css("left") && C.css({left: 0}), "auto" == C.css("top") && (C.css({top: M}), L = M), C.hide(), O.length && (u.first().text() != x.text() && y.addClass("changed"), y.data("jqfs-class", O.data("jqfs-class")), y.addClass(O.data("jqfs-class"))), n.is(":disabled")) return y.addClass("disabled"), !1;
                        b.click(function () {
                            if (t("div.jq-selectbox").filter(".opened").length && s.onSelectClosed.call(t("div.jq-selectbox").filter(".opened")), n.focus(), !o) {
                                var e = t(window), i = S.data("li-height"), a = y.offset().top,
                                    l = e.height() - M - (a - e.scrollTop()), c = n.data("visible-options");
                                void 0 !== c && "" !== c || (c = s.selectVisibleOptions);
                                var d = 5 * i, h = i * c;
                                c > 0 && 6 > c && (d = h), 0 === c && (h = "auto");
                                var p = function () {
                                    C.height("auto").css({bottom: "auto", top: L});
                                    var t = function () {
                                        k.css("max-height", Math.floor((l - 20 - j) / i) * i)
                                    };
                                    t(), k.css("max-height", h), "none" != $ && k.css("max-height", $), l < C.outerHeight() + 20 && t()
                                }, f = function () {
                                    C.height("auto").css({top: "auto", bottom: L});
                                    var t = function () {
                                ...
                                !0 === _ || 1 === _ ? l > d + j + 20 ? (p(), y.removeClass("dropup").addClass("dropdown")) : (f(), y.removeClass("dropdown").addClass("dropup")) : !1 === _ || 0 === _ ? l > d + j + 20 && (p(), y.removeClass("dropup").addClass("dropdown")) : (C.height("auto").css({
                                    ...
                                    left: "auto",
                                    right: 0
                                }), t("div.jqselect").css({zIndex: v - 1}).removeClass("opened"), y.css({zIndex: v}), C.is(":hidden") ? (t("div.jq-selectbox__dropdown:visible").hide(), C.show(), y.addClass("opened focused"), s.onSelectOpened.call(y)) : (C.hide(), y.removeClass("opened dropup dropdown"), t("div.jq-selectbox").filter(".opened").length && s.onSelectClosed.call(y)), T.length && (T.val("").keyup(), I.hide(), T.keyup(function () {
                                    var e = t(this).val();
                                    S.each(function () {
                    ...
                    function d() {
                        ...
                        n.css({margin: 0, padding: 0}).after(s), l(), s.append("<ul>" + h + "</ul>");
                        var o = t("ul", s).css({
                                position: "relative",
                                "overflow-x": "hidden",
                                "-webkit-overflow-scrolling": "touch"
                            }), a = t("li", s).attr("unselectable", "on"), c = n.attr("size"), d = o.outerHeight(),
                            p = a.outerHeight();
                        void 0 !== c && c > 0 ? o.css({height: p * c}) : o.css({height: 4 * p}), d > s.height() && (o.css("overflowY", "scroll"), r(o), a.filter(".selected").length && o.scrollTop(o.scrollTop() + a.filter(".selected").position().top)), n.prependTo(s).css({
                            position: "absolute",
                            left: 0,
                            top: 0,
                            width: "100%",
    ...
    function n(t) {
        return function (e) {
            ...
            if (n) for (var o = 0, a = n.length; o < a; ++o) {
                var r = n[o].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/), c = i(r[0]), d = r[1] || "", u = r[3] || "",
                    h = null;
    ...
    var o = [], a = [], r = {precision: 100, elapse: !1, defer: !1};
    ...
    var e, i, n, s, o, a, r = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", u = "Change", h = "mfp",
        p = "." + h, f = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function () {
        }, _ = !!window.jQuery, y = t(window), b = function (t, i) {
            e.ev.on(h + t + p, i)
        }, w = function (e, i, n, s) {
    ...
    v.prototype = {
        ...
        if ("string" == typeof i) if ("open" === i) {
            var s, o = _ ? n.data("magnificPopup") : n[0].magnificPopup, a = parseInt(arguments[1], 10) || 0;
        ...
        options: {
            ...
            initZoom: function () {
                ...
                if (i.enabled && e.supportsTransition) {
                    var s, o, a = i.duration, c = function (t) {
                ...
                var s = n.offset(), o = parseInt(n.css("padding-top"), 10), a = parseInt(n.css("padding-bottom"), 10);
                s.top -= t(window).scrollTop() - o;
                var r = {width: n.width(), height: (_ ? n.innerHeight() : n[0].offsetHeight) - a - o};
                return z() ? r["-moz-transform"] = r.transform = "translate(" + s.left + "px," + s.top + "px)" : (r.left = s.left, r.top = s.top), r
            }
        }
    });
    var F = "iframe", H = "//about:blank", W = function (t) {
        if (e.currTemplate[F]) {
    ...
    s.Defaults = {
        ...
        var s = -1, o = 30, a = this.width(), r = this.coordinates();
            ...
            "initialized.owl.carousel change.owl.carousel resized.owl.carousel": t.proxy(function (e) {
                if (e.namespace && this._core.settings && this._core.settings.lazyLoad && (e.property && "position" == e.property.name || "initialized" == e.type)) {
                    var i = this._core.settings, s = i.center && Math.ceil(i.items / 2) || i.items,
                        ...
                        r = this._core.clones().length, l = t.proxy(function (t, e) {
                            this.load(e)
                        }, this);
    ...
    s.Defaults = {autoHeight: !1, autoHeightClass: "owl-height"}, s.prototype.update = function () {
        var e = this._core._current, i = e + this._core.settings.items, n = this._core.settings.lazyLoad,
            s = this._core.$stage.children().toArray().slice(e, i), o = [], a = 0;
    ...
    s.Defaults = {video: !1, videoHeight: !1, videoWidth: !1}, s.prototype.fetch = function (t, e) {
        ...
        if (n = a.match(/(http:|https:|)\/\/(player.|www.|app.)?(vimeo\.com|youtu(be\.com|\.be|be\.googleapis\.com|be\-nocookie\.com)|vzaar\.com)\/(video\/|videos\/|embed\/|channels\/.+\/|groups\/.+\/|watch\?v=|v\/)?([A-Za-z0-9._%-]*)(\&\S+)?/), n[3].indexOf("youtu") > -1) i = "youtube"; else if (n[3].indexOf("vimeo") > -1) i = "vimeo"; else {
        ...
        var n, s, o, a = i.width && i.height ? "width:" + i.width + "px;height:" + i.height + "px;" : "",
            r = e.find("img"), l = "src", c = "", d = this._core.settings, u = function (i) {
        ...
        var i, n = t(e.target), s = n.closest("." + this._core.settings.itemClass),
            o = this._videos[s.attr("data-video")], a = o.width || "100%", r = o.height || this._core.$stage.height();
    ...
    return function (t, e, i, n) {
        var s = {
            features: null, bind: function (t, e, i, n) {
                ...
                var t = s.createEl(), e = t.style, i = "", n = {};
        ...
        s.extend(l, n);
        var c, d, u, h, p, f, m, g, v, _, y, b, w, x, C, k, S, T, I, D, E, A, P, M, j, $, O, N, L, z, F, H, W, R, B, q,
            U, Y, K, V, Q, Z, G, X, J, tt, et, it, nt, st, ot, at, rt, lt, ct, dt, ut, ht = function () {
                return {x: 0, y: 0}
            }, pt = ht(), ft = ht(), mt = ht(), gt = {}, vt = 0, _t = {}, yt = ht(), bt = 0, wt = !0, xt = [], Ct = {},
            kt = !1, St = function (t, e) {
                ...
                if (!l.loop && e) {
                    var i = h + (yt.x * vt - t) / yt.x, n = Math.round(t - ye.x);
                ...
                A = "left", s.addClass(t, "pswp--ie"), Ot = function (t, e) {
                    ...
                    var e = t.fitRatio > 1 ? 1 : t.fitRatio, i = t.container.style, n = e * t.w, s = e * t.h;
                    i.width = n + "px", i.height = s + "px", i.left = t.initialPosition.x + "px", i.top = t.initialPosition.y + "px"
                }, jt = function () {
                    if (st) {
                        var t = st, e = o.currItem, i = e.fitRatio > 1 ? 1 : e.fitRatio, n = i * e.w, s = i * e.h;
                ...
                shout: Et, listen: Dt, viewportSize: gt, options: l, isMainScrollAnimating: function () {
                    return ot
            ...
            }, oe = 30, ae = 10, re = {}, le = {}, ce = {}, de = {}, ue = {}, he = [], pe = {}, fe = [], me = {}, ge = 0,
            ve = ht(), _e = 0, ye = ht(), be = ht(), we = ht(), xe = function (t, e) {
                ...
                var i, n, s, a, r = mt[t] + e[t], c = e[t] > 0, d = ye.x + e.x, u = ye.x - pe.x;
                ...
                if (!("mousedown" === t.type && t.button > 0)) {
                    ...
                    if (!Y || "mousedown" !== t.type) {
                        if (Ae(t, !0) && t.preventDefault(), Et("pointerDown"), P) {
                            ...
                            e < 0 && (e = he.length), he[e] = {x: t.pageX, y: t.pageY, id: t.pointerId}
                        }
                ...
                if (K) {
                    var n = ze(t);
                    if (at || Z || tt) J = n; else if (ye.x !== yt.x * vt) at = "h"; else {
                ...
                if (J) {
                    var t = J.length;
                    if (0 !== t) if (zt(re, J[0]), ce.x = re.x - de.x, ce.y = re.y - de.y, tt && t > 1) {
                        if (de.x = re.x, de.y = re.y, !ce.x && !ce.y && xe(J[1], le)) return;
                        zt(le, J[1]), Q || (Q = !0, Et("zoomGestureStarted"));
                        var e = ke(re, le), i = Ke(e);
                        i > o.currItem.initialZoomLevel + o.currItem.initialZoomLevel / 15 && (dt = !0);
                        var n = 1, s = Ut(), a = Yt();
                        if (i < s) if (l.pinchToClose && !dt && y <= o.currItem.initialZoomLevel) {
                            var r = s - i, c = 1 - r / (s / 1.2);
                            Pt(c), Et("onPinchClose", c), lt = !0
                        } else n = (s - i) / s, n > 1 && (n = 1), i = s - n * (s / 3); else i > a && (n = (i - a) / (6 * s), n > 1 && (n = 1), i = a + n * s);
                ...
                if (P) {
                    ...
                    if (i > -1) if (e = he.splice(i, 1)[0], navigator.msPointerEnabled) {
                        var n = {4: "mouse", 2: "touch", 3: "pen"};
                        e.type = n[t.pointerType], e.type || (e.type = t.pointerType || "mouse")
                    } else e.type = t.pointerType || "mouse"
                }
                var a, r = ze(t), c = r.length;
                ...
                var d = -1;
                if (0 === c && (K = !1, s.unbind(window, m, o), Se(), tt ? d = 0 : -1 !== _e && (d = At() - _e)), _e = 1 === c ? At() : -1, a = -1 !== d && d < 150 ? "zoom" : "swipe", tt && c < 2 && (tt = !1, 1 === c && (a = "zoomPointerUp"), Et("zoomGestureEnded")), J = null, Z || Q || ot || U) if (ie(), B || (B = qe()), B.calculateSwipeSpeed("x"), U) {
                    var u = $e();
                ...
                var n;
                if ("swipe" === t) {
                    var a = de.x - ue.x, r = e.lastFlickDist.x < 10;
                ...
                var d, u = yt.x * vt, p = Math.abs(u - ye.x);
        ...
        var Qe, Ze, Ge, Xe, Je, ti, ei, ii = function (e, i, n, a) {
            ...
            !function () {
                var i = u, a = !o.currItem.src || o.currItem.loadError || l.showHideOpacity;
                e.miniImg && (e.miniImg.style.webkitBackfaceVisibility = "hidden"), n || (_ = r.w / e.w, mt.x = r.x, mt.y = r.y - N, o[a ? "template" : "bg"].style.opacity = .001, jt()), ee("initialZoom"), n && !i && s.removeClass(t, "pswp--animated-in"), a && (n ? s[(i ? "remove" : "add") + "Class"](t, "pswp--animate_opacity") : setTimeout(function () {
                    ...
                    if (Et("initialZoom" + (n ? "Out" : "In")), n) {
                        var o = r.w / e.w, l = {x: mt.x, y: mt.y}, u = _, h = ct, p = function (e) {
            ...
            var e = t.img = s.createEl("pswp__img", "img"), i = function () {
            ...
            publicMethods: {
                lazyLoadItem: function (t) {
                    ...
                    s.extend(l, oi, !0), o.items = Ze = i, Je = o.getItemAt, ti = l.getNumItemsFn, ei = l.loop, ti() < 3 && (l.loop = !1), Dt("beforeChange", function (t) {
                        var e, i = l.preload, n = null === t || t >= 0, s = Math.min(i[0], ti()),
                            a = Math.min(i[1], ti());
                    ...
                    if (!a.src && a.html && (a.html.tagName ? r.appendChild(a.html) : r.innerHTML = a.html), ui(a), li(a, gt), !a.src || a.loadError || a.loaded) a.src && !a.loadError && (n = s.createEl("pswp__img", "img"), n.style.opacity = 1, n.src = a.src, hi(a, n), ci(e, a, r, n, !0)); else {
        ...
        St("DesktopZoom", {
            publicMethods: {
                initDesktopZoom: function () {
                    ...
                    e = e || {x: gt.x / 2 + _t.x, y: gt.y / 2 + _t.y};
                    var i = l.getDoubleTapZoom(!0, o.currItem), n = _ === i;
                    o.mouseZoomedIn = !n, o.zoomTo(n ? o.currItem.initialZoomLevel : i, e, 333), s[(n ? "remove" : "add") + "Class"](t, "pswp--zoomed-in")
                }
            }
        });
        var _i, yi, bi, wi, xi, Ci, ki, Si, Ti, Ii, Di, Ei, Ai = {history: !0, galleryUID: 1}, Pi = function () {
            ...
            if (l.galleryPIDs) {
                var o = e.pid;
                for (e.pid = 0, i = 0; i < Ze.length; i++) if (Ze[i].pid === o) {
                    e.pid = i;
                    break
                }
    ...
    "use strict";
    return function (t, e) {
        var i, n, s, o, a, r, l, c, d, u, h, p, f, m, g, v, _, y, b, w = this, x = !1, C = !0, k = !0, S = {
            ...
            if (I()) {
                var a = g.barsSize;
                if (g.captionEl && "auto" === a.bottom) if (o || (o = e.createEl("pswp__caption pswp__caption--fake"), o.appendChild(e.createEl("pswp__caption__center")), n.insertBefore(o, s), e.addClass(n, "pswp__ui--fit")), g.addCaptionHTMLFn(t, o, !0)) {
                    var r = o.clientHeight;
                    i.bottom = parseInt(r, 10) || 44
                } else i.bottom = a.top; else i.bottom = "auto" === a.bottom ? 0 : a.bottom;
                i.top = a.top
            ...
            var t, i, s, o = function (n) {
                if (n) for (var o = n.length, a = 0; a < o; a++) {
                    t = n[a], i = t.className;
    ...
    function i(i, n, o, r, l) {
        ...
        function d(t) {
            var o = n.defaultImage, a = n.placeholder, r = n.imageBase, l = n.srcsetAttribute, c = n.loaderAttribute,
                d = n._f || {};
            t = s(t).filter(function () {
                var t = s(this), i = g(this);
                return !t.data(n.handledName) && (t.attr(n.attribute) || t.attr(l) || t.attr(c) || d[i] !== e)
            }).data("plugin_" + n.name, i);
            for (var u = 0, h = t.length; u < h; u++) {
                var p = s(t[u]), f = g(t[u]), m = p.attr(n.imageBaseAttribute) || r;
        ...
        function u(t, e) {
            ...
            for (var a = e || o, r = !1, l = n.imageBase || "", c = n.srcsetAttribute, d = n.handledName, u = 0; u < a.length; u++) if (t || e || p(a[u])) {
                var f = s(a[u]), m = g(a[u]), v = f.attr(n.attribute), _ = f.attr(n.imageBaseAttribute) || l,
        ...
        function h(t, e, i, o) {
            ...
            b("beforeLoad", t);
            var r = n.attribute, l = n.srcsetAttribute, c = n.sizesAttribute, d = n.retinaAttribute,
                u = n.removeAttribute, h = n.loadedName, p = t.attr(d);
            if (o) {
                var f = function () {
        ...
        function p(t) {
            var e = t.getBoundingClientRect(), i = n.scrollDirection, s = n.threshold,
                o = m() + s > e.top && -s < e.bottom, a = f() + s > e.left && -s < e.right;
        ...
        var w = 0, x = -1, C = -1, k = !1, S = "afterLoad", T = "load", I = "error", D = "img", E = "src", A = "srcset",
            P = "sizes", M = "background-image";
        "event" === n.bind || a ? c() : s(t).on(T + "." + l, c)
    }

    function n(n, a) {
        var r = this, l = s.extend({}, r.config, a), c = {}, d = l.name + "-" + ++o;
    ...
    var s = t.jQuery || t.Zepto, o = 0, a = !1;
    ...
    fontSpy = function (t, i) {
        var n = e("html"), s = e("body"), o = t;
        if ("string" != typeof o || "" === o) throw"A valid fontName is required. fontName must be a string and must not be an empty string.";
        var a = {
                font: o, fontClass: o.toLowerCase().replace(/\s/g, ""), success: function () {
                }, failure: function () {
                }, testFont: "Courier New", testString: "QW@HhsXJ", glyphs: "", delay: 50, timeOut: 1e3, callback: e.noop
            }, r = e.extend(a, i),
    ...
    function i(e, i) {
        ...
        function E(t) {
            ...
            if (Yt !== x && Yt !== C && !lt()) {
                var n, s = e.touches, o = s ? s[0] : e, a = ht(o);
        ...
        function A(t) {
            var e = t.originalEvent ? t.originalEvent : t, n = e.touches;
            if (n) {
        ...
        var i = t.extend({}, i), Et = k || T || !i.fallbackToMouseEvents,
            ...
            $t = T ? S ? "MSPointerCancel" : "pointercancel" : "touchcancel", Ot = 0, Nt = null, Lt = null, zt = 0,
            Ft = 0, Ht = 0, Wt = 1, Rt = 0, Bt = 0, qt = null, Ut = t(e), Yt = "start", Kt = 0, Vt = {}, Qt = 0, Zt = 0,
            Gt = 0, Xt = 0, Jt = 0, te = null, ee = null;
        try {
    ...
    var n = "left", s = "right", o = "up", a = "down", r = "in", l = "out", c = "none", d = "auto", u = "swipe",
        h = "pinch", p = "tap", f = "doubletap", m = "longtap", g = "horizontal", v = "vertical", _ = "all", y = 10,
        b = "start", w = "move", x = "end", C = "cancel", k = "ontouchstart" in window,
        S = window.navigator.msPointerEnabled && !window.PointerEvent && !k,
        T = (window.PointerEvent || window.navigator.msPointerEnabled) && !k, I = "TouchSwipe", D = {
            fingers: 1,
            threshold: 75,
    ...
    t.fn.swipe = function (i) {
        ...
        } else if (s && "object" == typeof i) s.option.apply(s, arguments); else if (!(s || "object" != typeof i && i)) return e.apply(this, arguments);
        return n
        ...
        PHASE_END: x,
        PHASE_CANCEL: C
    }, t.fn.swipe.directions = {LEFT: n, RIGHT: s, UP: o, DOWN: a, IN: r, OUT: l}, t.fn.swipe.pageScroll = {
        NONE: c,
        HORIZONTAL: g,
        VERTICAL: v,
        AUTO: d
    ...
    t.fn.lazyLoad = function (e, i) {
        ...
        function o() {
            var t, e = 350, i = setTimeout(t = function () {
                ...
                if (a.loading) i = setTimeout(t, e); else {
                    c(l, r);
        ...
        var r = t(window), l = a.container || t(this);
        n();
    ...
    function e(t, e) {
        this.path = t, void 0 !== e && null !== e ? (this.at_2x_path = e, this.perform_check = !1) : (this.at_2x_path = t.replace(/\.\w+$/, function (t) {
            return "@2x" + t
    ...
    function i(i) {
        if (!/@2x\.\w+$/.test(t(i).attr("src"))) {
            this.el = i, this.path = new e(t(i).attr("src"), t(i).attr("data-atretina"));
            var n = this;
    ...
    t.fn.retina = function (e) {
        if (t.Retina.isRetina()) return t.Retina.opts = t.extend(t.Retina.opts, e), this.each(function () {
            t(this).is("img") && new i(this)
        })
    }, t.Retina = function () {
    }, t.Retina.opts = {check_mime_type: !0, force_original_dimensions: !0}, t.Retina.isRetina = function () {
    ...
    }, e.confirmed_paths = [], e.prototype.is_external = function () {
        return !(!this.path.match(/^(https?\:|\/\/)/i) || this.path.match("//" + document.domain + "/"))
    }, e.prototype.check_2x_variant = function (i) {
        var n, s = this;
        if (this.is_external() || !this.perform_check && void 0 !== this.at_2x_path && null !== this.at_2x_path || this.at_2x_path in e.confirmed_paths) return i(!0);
        n = new XMLHttpRequest, n.open("HEAD", this.at_2x_path), n.onreadystatechange = function () {
            if (4 == n.readyState && 200 <= n.status && 399 >= n.status) {
                if (t.Retina.opts.check_mime_type) {
                    var o = n.getResponseHeader("Content-Type");
                    if (null === o || !o.match(/^image/i)) return i(!1)
                }
                return e.confirmed_paths.push(s.at_2x_path), i(!0)
            }
            return i(!1)
        }, n.send()
        ...
        function i() {
            if (n.el.complete) {
                t.Retina.opts.force_original_dimensions && (n.el.setAttribute("width", n.el.offsetWidth), n.el.setAttribute("height", n.el.offsetHeight));
                var s = n.el.src;
                n.el.setAttribute("src", e), t(n.el).one("error", function () {
                    n.el.setAttribute("src", s)
                })
            } else setTimeout(i, 5)
        }
    ...
    t.ui = t.ui || {}, t.ui.version || (t.extend(t.ui, {
        ...
        propAttr: t.fn.prop || t.fn.attr, _focus: t.fn.focus, focus: function (e, i) {
    ...
    t.widget = function (e, i, n) {
        ...
        t.fn[i] = function (s) {
            var o = "string" == typeof s, a = Array.prototype.slice.call(arguments, 1), r = this;
            return s = !o && a.length ? t.extend.apply(null, [!0, s].concat(a)) : s, o && "_" === s.charAt(0) ? r : (o ? this.each(function () {
                var n = t.data(this, i), o = n && t.isFunction(n[s]) ? n[s].apply(n, a) : n;
        ...
        widgetName: "widget", widgetEventPrefix: "", options: {disabled: !1}, _createWidget: function (e, i) {
    ...
    t.widget("ui.slider", t.ui.mouse, {
        ...
        _create: function () {
            ...
            if (this._mouseSliding = this._keySliding = !1, this._animateOff = !0, this._handleIndex = null, this._detectOrientation(), this._mouseInit(), this.element.addClass("ui-slider ui-slider-" + this.orientation + " ui-widget ui-widget-content ui-angle-all"), i.disabled && this.element.addClass("ui-slider-disabled ui-disabled"), this.range = t([]), i.range && (!0 === i.range ? (this.range = t("<div></div>"), i.values || (i.values = [this._valueMin(), this._valueMin()]), i.values.length && 2 !== i.values.length && (i.values = [i.values[0], i.values[0]])) : this.range = t("<div></div>"), this.range.appendTo(this.element).addClass("ui-slider-range"), "min" !== i.range && "max" !== i.range || this.range.addClass("ui-slider-range-" + i.range), this.range.addClass("ui-widget-header")), 0 === t(".ui-slider-handle", this.element).length && t("<a href='#'></a>").appendTo(this.element).addClass("ui-slider-handle"), i.values && i.values.length) for (; t(".ui-slider-handle", this.element).length < i.values.length;) t("<a href='#'></a>").appendTo(this.element).addClass("ui-slider-handle");
            this.handles = t(".ui-slider-handle", this.element).addClass("ui-state-default ui-angle-all"), this.handle = this.handles.eq(0), this.handles.add(this.range).filter("a").click(function (t) {
                ...
                var n, s, o, a = !0, r = t(this).data("index.ui-slider-handle");
        ...
        _mouseCapture: function (e) {
            ...
            } : {left: 0, top: 0}, n = this._normValueFromMouse(i), this._slide(e, r, n), this._animateOff = !0))
        },
        ...
        _refreshValue: function () {
            ...
            this.options.values && this.options.values.length ? this.handles.each(function (n) {
                e = (l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, d["horizontal" === l.orientation ? "left" : "bottom"] = e + "%", t(this).stop(1, 1)[c ? "animate" : "css"](d, r.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[c ? "animate" : "css"]({left: e + "%"}, r.animate), 1 === n && l.range[c ? "animate" : "css"]({width: e - i + "%"}, {
                    queue: !1,
                    duration: r.animate
                })) : (0 === n && l.range.stop(1, 1)[c ? "animate" : "css"]({bottom: e + "%"}, r.animate), 1 === n && l.range[c ? "animate" : "css"]({height: e - i + "%"}, {
                    queue: !1,
                    duration: r.animate
                }))), i = e
            }) : (n = this.value(), s = this._valueMin(), o = this._valueMax(), e = o !== s ? (n - s) / (o - s) * 100 : 0, d["horizontal" === l.orientation ? "left" : "bottom"] = e + "%", this.handle.stop(1, 1)[c ? "animate" : "css"](d, r.animate), "min" === a && "horizontal" === this.orientation && this.range.stop(1, 1)[c ? "animate" : "css"]({width: e + "%"}, r.animate), "max" === a && "horizontal" === this.orientation && this.range[c ? "animate" : "css"]({width: 100 - e + "%"}, {
                queue: !1,
                duration: r.animate
            }), "min" === a && "vertical" === this.orientation && this.range.stop(1, 1)[c ? "animate" : "css"]({height: e + "%"}, r.animate), "max" === a && "vertical" === this.orientation && this.range[c ? "animate" : "css"]({height: 100 - e + "%"}, {
                queue: !1,
                duration: r.animate
            }))
        }
    ...
    t.zoom = function (e, i, n, s) {
        var o, a, r, l, c, d, u, h = t(e), p = h.css("position"), f = t(i);
        ...
        return this.each(function () {
            var n = t.extend({}, e, i || {}), s = n.target && t(n.target)[0] || this, o = this, a = t(o),
                r = document.createElement("img"), l = t(r), c = "mousemove.zoom", d = !1, u = !1;
            if (!n.url) {
...
}(window.jQuery), function (t, e, i, n) {
    i.swipebox = function (s, o) {
        var a, r, l = {
            ...
            g = t.innerWidth ? t.innerWidth : i(t).width(), v = t.innerHeight ? t.innerHeight : i(t).height(), _ = 0;
        c.settings = {}, i.swipebox.close = function () {
            ...
            init: function (t) {
                ...
                var t, e, n, s, o, a, r = this, l = !1, c = !1, u = 10, h = 50, p = {}, f = {},
                    m = i("#swipebox-top-bar, #swipebox-bottom-bar"), v = i("#swipebox-slider");
                m.addClass("visible-bars"), r.setTimeout(), i("body").bind("touchstart", function (r) {
                    return i(this).addClass("touching"), t = i("#swipebox-slider .slide").index(i("#swipebox-slider .slide.current")), f = r.originalEvent.targetTouches[0], p.pageX = r.originalEvent.targetTouches[0].pageX, p.pageY = r.originalEvent.targetTouches[0].pageY, i("#swipebox-slider").css({
                        ...
                        if (r.preventDefault(), r.stopPropagation(), f = r.originalEvent.targetTouches[0], !c && (o = n, n = f.pageY - p.pageY, Math.abs(n) >= h || l)) {
                            ...
                            v.css({top: n + "px"}), v.css({opacity: m}), l = !0
                        }
                    ...
                    }), n = f.pageY - p.pageY, e = f.pageX - p.pageX, a = 100 * e / g, l) if (l = !1, Math.abs(n) >= 2 * h && Math.abs(n) > Math.abs(o)) {
                        var d = n > 0 ? v.height() : -v.height();
                        v.animate({top: d + "px", opacity: 0}, 300, function () {
                            r.closeSlide()
                        })
                    } else v.animate({
                        top: 0,
                        opacity: 1
                    }, 300); else c ? (c = !1, e >= u && e >= s ? r.getPrev() : e <= -u && e <= s && r.getNext()) : m.hasClass("visible-bars") ? (r.clearTimeout(), r.hideBars()) : (r.showBars(), r.setTimeout());
                ...
                }) : n.animate({left: 100 * -t + "%"}), i("#swipebox-slider .slide").removeClass("current"), i("#swipebox-slider .slide").eq(t).addClass("current"), c.settings.thumbs && (i(".js-swipebox-thumbs-el").removeClass("active"), i('.js-swipebox-thumbs-el[data-index="' + t + '"]').addClass("active")), this.setTitle(t), e && n.fadeIn(), i("#swipebox-prev, #swipebox-next").removeClass("disabled"), 0 === t ? i("#swipebox-prev").addClass("disabled") : t === d.length - 1 && !0 !== c.settings.loopAtEnd && i("#swipebox-next").addClass("disabled")
                ...
                var t, e = this, n = i("#swipebox-slider .slide").index(i("#swipebox-slider .slide.current"));
